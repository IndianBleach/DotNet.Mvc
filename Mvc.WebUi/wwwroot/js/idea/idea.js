        ...
        $.get("/idea/boxes/detail", { boxGuid }, resp => {
            ...
            resp.goals.forEach(item => {
                if (item.canEdit == true) {
                    ...
                    switch (item.status) {
                        case 1:
                            $("#boxContentWrapper").append(`<div class="mb-3 topicDiscussMessage"><a href="/user/${item.authorGuid}"><img src="/media/userAvatars/${item.authorAvatarImage}" /></a><div class="boxGoalContent"><div><p class="col mb-0 t-semi-bold t-muted"><span class="pe-1">${item.authorName}</span>${item.content}</p></div><div class="mb-0 upd-goal goal-waiting me-1"><span>Waiting</span></div></div></div>`);
                            break;
                        case 2:
                            $("#boxContentWrapper").append(`<div class="mb-3 topicDiscussMessage"><a href="/user/${item.authorGuid}"><img src="/media/userAvatars/${item.authorAvatarImage}" /></a><div class="boxGoalContent"><div><p class="col mb-0 t-semi-bold t-muted"><span class="pe-1">${item.authorName}</span>${item.content}</p></div><div class="mb-0 upd-goal goal-failed me-1"><span>Failed</span></div></div></div>`);
                            break;
                        case 0:
                            $("#boxContentWrapper").append(`<div class="mb-3 topicDiscussMessage"><a href="/user/${item.authorGuid}"><img src="/media/userAvatars/${item.authorAvatarImage}" /></a><div class="boxGoalContent"><div><p class="col mb-0 t-semi-bold t-muted"><span class="pe-1">${item.authorName}</span>${item.content}</p></div><div class="mb-0 upd-goal goal-complete me-1"><span>Complete</span></div></div></div>`);
                            break;
                    };
                }
            });
    ...
    $("#boxNewGoalForm").on("submit", (e) => {
        ...
        $.post("/idea/boxes/creategoal", { boxGuid, content }, (resp) => {
            if (resp.canEdit == true) {
                ...
                switch (resp.status) {
                    case 1:
                        $("#boxContentWrapper").append(`<div class="mb-3 topicDiscussMessage"><a href="/user/${resp.authorGuid}"><img src="/media/userAvatars/${resp.authorAvatarImage}" /></a><div class="boxGoalContent"><div><p class="col mb-0 t-semi-bold t-muted"><span class="pe-1">${resp.authorName}</span>${resp.content}</p></div><div class="mb-0  upd-goal goal-waiting me-1"><span>Waiting</span></div></div></div>`);
                        break;
                    case 2:
                        $("#boxContentWrapper").append(`<div class="mb-3 topicDiscussMessage"><a href="/user/${resp.authorGuid}"><img src="/media/userAvatars/${resp.authorAvatarImage}" /></a><div class="boxGoalContent"><div><p class="col mb-0 t-semi-bold t-muted"><span class="pe-1">${resp.authorName}</span>${resp.content}</p></div><div class="mb-0  upd-goal goal-failed me-1"><span>Failed</span></div></div></div>`);
                        break;
                    case 0:
                        $("#boxContentWrapper").append(`<div class="mb-3 topicDiscussMessage"><a href="/user/${resp.authorGuid}"><img src="/media/userAvatars/${resp.authorAvatarImage}" /></a><div class="boxGoalContent"><div><p class="col mb-0 t-semi-bold t-muted"><span class="pe-1">${resp.authorName}</span>${resp.content}</p></div><div class="mb-0  upd-goal goal-complete me-1"><span>Complete</span></div></div></div>`);
                        break;
                };
            }
